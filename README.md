...
product-minded engineer building ai agents and developer tools

---

#### what i'm focused on

- **ai agents & dev tools** — building tools that make developers and ai agents work better together
...
`typescript` `python` `go` `react` `swift`

---

[𝕏](https://x.com/mattlam_) · [@pichangelog](https://x.com/pichangelog) · [@codexchangelog_](https://x.com/codexchangelog_) · [linkedin](https://www.linkedin.com/in/matt-lam/) · [github](https://github.com/minghinmatthewlam)
